...
- Landing page: `https://smart-logistics-api-nrfd.onrender.com/`
...
- `client/src/App.tsx` owns the app shell, auth state, dashboard visibility, and data refresh flow.
...
If the user is not signed in, opening the dashboard presents the auth dialog. After sign-in, the dashboard loads live API data where available and exposes a breadcrumb-style dropdown navigation for Overview, Warehouses, Inventory, Transfers, Settings, and API Docs.
